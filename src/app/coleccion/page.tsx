...
export default async function CollectionPage() {
  ...
  return (
    <>
      ...
      <section className="pt-28 lg:pt-36 bg-rio-oscuro text-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="border-b border-white/10 pb-8 lg:pb-12">
            ...
            <p className="font-serif text-4xl md:text-5xl lg:text-6xl leading-[0.95]">
              La <em className="italic text-calabaza/90">Colección</em>
            </p>
            <p className="font-body text-sm text-white/45 leading-relaxed mt-6 max-w-xl">
